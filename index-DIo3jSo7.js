import { a as qe, e as ot, b as Ie, d as $e, f as bi, h as pi, S as _i } from "./index-CbPxOOAJ.js";
function yi(e) {
  return "_:" + e.value;
}
function wi(e, t) {
...
function mi(e) {
  return Si.test(e) ? e.replace(Ei, Ai) : e;
}
function vi(e) {
  const t = mi(e.value);
  return e.datatype.value === "http://www.w3.org/2001/XMLSchema#string" ? '"' + t + '"' : e.datatype.value === "http://www.w3.org/1999/02/22-rdf-syntax-ns#langString" ? '"' + t + '"@' + e.language : '"' + t + '"^^' + un(e.datatype);
}
function Ti(e, t) {
  const r = t(e.subject), i = t(e.predicate), l = t(e.object), s = t(e.graph);
  return `${r} ${i} ${l} ${s ? s + " " : ""}.`;
}
function Ii(e) {
  return "?" + e.value;
...
(function(e) {
  const t = Ie, { kResistStopPropagation: r, SymbolDispose: i } = H, l = globalThis.AbortSignal || qe().AbortSignal, s = globalThis.AbortController || qe().AbortController, d = Object.getPrototypeOf(async function() {
...
`;
  ...
  e.exports = {
    ...
    addAbortListener: ot.addAbortListener || function(u, m) {
      if (u === void 0)
...
var te = cn.exports, er = {};
const { format: $i, inspect: rt, AggregateError: Ni } = te, Di = globalThis.AggregateError || Ni, Mi = Symbol("kIsNodeError"), ki = [
  "string",
  "function",
  "number",
  "object",
  ...
  "bigint",
  "symbol"
], Pi = /^([A-Z][a-z0-9]*)+$/, Li = "__node_internal_", lt = {};
function ve(e, t) {
  if (!e)
...
function Q(e, t, r) {
  ...
  }), i.prototype.code = e, i.prototype[Mi] = !0, lt[e] = i;
}
function Ar(e) {
  const t = Li + e.name;
...
let Wi = class extends Error {
  constructor(t = "The operation was aborted", r = void 0) {
    if (r !== void 0 && typeof r != "object")
      throw new lt.ERR_INVALID_ARG_TYPE("options", "Object", r);
...
Q(
  ...
  (e, t, r) => {
    ...
    const l = [], s = [], d = [];
    for (const R of t)
      ve(typeof R == "string", "All expected entries have to be of type string"), ki.includes(R) ? l.push(R.toLowerCase()) : Pi.test(R) ? s.push(R) : (ve(R !== "object", 'The value "object" should be written as "Object"'), d.push(R));
    if (s.length > 0) {
...
Q(
  ...
  (e, t, r) => {
    ...
    let i;
    return Number.isInteger(r) && Math.abs(r) > 2 ** 32 ? i = Rr(String(r)) : typeof r == "bigint" ? (i = String(r), (r > 2n ** 32n || r < -(2n ** 32n)) && (i = Rr(i)), i += "n") : i = rt(r), `The value of "${e}" is out of range. It must be ${t}. Received ${i}`;
  },
  RangeError
);
...
var ie = {
  AbortError: Wi,
  aggregateTwoErrors: Ar(xi),
  hideStackFrames: Ar,
  codes: lt
};
const {
  ArrayIsArray: tr,
  ArrayPrototypeIncludes: hn,
  ArrayPrototypeJoin: bn,
  ArrayPrototypeMap: Ci,
  NumberIsInteger: rr,
  NumberIsNaN: ji,
  NumberMAX_SAFE_INTEGER: Fi,
  NumberMIN_SAFE_INTEGER: Ui,
  NumberParseInt: Bi,
  ObjectPrototypeHasOwnProperty: Gi,
  RegExpPrototypeExec: pn,
  String: Vi,
  StringPrototypeToUpperCase: Hi,
  StringPrototypeTrim: qi
} = H, {
  hideStackFrames: ae,
  codes: { ERR_SOCKET_BAD_PORT: Yi, ERR_INVALID_ARG_TYPE: ee, ERR_INVALID_ARG_VALUE: je, ERR_OUT_OF_RANGE: Te, ERR_UNKNOWN_SIGNAL: mr }
} = ie, { normalizeEncoding: zi } = te, { isAsyncFunction: Ki, isArrayBufferView: Xi } = te.types, vr = {};
function Ji(e) {
  return e === (e | 0);
}
function Qi(e) {
...
const Zi = /^[0-7]+$/, eo = "must be a 32-bit unsigned integer or an octal string";
function to(e, t, r) {
...
}), no = ae((e, t, r = -2147483648, i = 2147483647) => {
  if (typeof e != "number")
    throw new ee(t, "number", e);
  if (!rr(e))
    throw new Te(t, "an integer", e);
...
function io(e, t, r = void 0, i) {
  if (typeof e != "number")
    throw new ee(t, "number", e);
  if (r != null && e < r || i != null && e > i || (r != null || i != null) && ji(e))
    throw new Te(
      t,
...
const oo = ae((e, t, r) => {
  if (!hn(r, e)) {
    const l = "must be one of: " + bn(
      Ci(r, (s) => typeof s == "string" ? `'${s}'` : Vi(s)),
      ", "
    );
    throw new je(t, e, l);
  }
...
function vt(e, t, r) {
  return e == null || !Gi(e, t) ? r : e[t];
}
const lo = ae((e, t, r = null) => {
  const i = vt(r, "allowArray", !1), l = vt(r, "allowFunction", !1);
  if (!vt(r, "nullable", !1) && e === null || !i && tr(e) || typeof e != "object" && (!l || typeof e != "function"))
...
function co(e, t = "signal") {
  if (nr(e, t), vr[e] === void 0)
    throw vr[Hi(e)] !== void 0 ? new mr(e + " (signals must use all capital letters)") : new mr(e);
}
const ho = ae((e, t = "buffer") => {
  if (!Xi(e))
    throw new ee(t, ["Buffer", "TypedArray", "DataView"], e);
});
function bo(e, t) {
  const r = zi(t), i = e.length;
  if (r === "hex" && i % 2 !== 0)
    throw new je("encoding", t, `is invalid for data of length ${i}`);
}
function po(e, t = "Port", r = !0) {
  if (typeof e != "number" && typeof e != "string" || typeof e == "string" && qi(e).length === 0 || +e !== +e >>> 0 || e > 65535 || e === 0 && !r)
    throw new Yi(t, e, r);
  return e | 0;
}
const wn = ae((e, t) => {
...
function go(e, t, r) {
  if (!hn(r, e))
    throw new ee(t, `('${bn(r, "|")}')`, e);
}
const So = /^(?:<[^>]*>)(?:\s*;\s*[^;"\s]+(?:=(")?[^;"\s]*\1)?)*$/;
function Tr(e, t) {
  if (typeof e > "u" || !pn(So, e))
    throw new je(
      t,
      e,
...
var Ye = {
  ...
  parseFileMode: to,
  validateArray: at,
  validateStringArray: so,
  validateBooleanArray: fo,
  validateAbortSignalArray: uo,
  validateBoolean: yn,
  validateBuffer: ho,
  validateDictionary: ao,
  validateEncoding: bo,
  validateFunction: _o,
  validateInt32: no,
  validateInteger: ro,
  ...
  validateObject: lo,
  validateOneOf: oo,
  validatePlainFunction: yo,
  validatePort: po,
  validateSignalName: co,
  validateString: nr,
  validateUint32: _n,
  validateUndefined: wo,
  validateUnion: go,
  validateAbortSignal: wn,
  validateLinkHeaderValue: Eo
}, ir = { exports: {} };
const { SymbolAsyncIterator: Ir, SymbolIterator: $r, SymbolFor: Ne } = H, gn = Ne("nodejs.stream.destroyed"), Sn = Ne("nodejs.stream.errored"), Gt = Ne("nodejs.stream.readable"), Vt = Ne("nodejs.stream.writable"), En = Ne("nodejs.stream.disturbed"), Ro = Ne("nodejs.webstream.isClosedPromise"), Ao = Ne("nodejs.webstream.controllerErrorFunction");
function st(e, t = !1) {
  var r;
...
function ut(e) {
  ...
  return !!(e.destroyed || e[gn] || i != null && i.destroyed);
}
function vn(e) {
  if (!ft(e))
    return null;
...
function In(e) {
  return e && e[Gt] != null ? e[Gt] : typeof (e == null ? void 0 : e.readable) != "boolean" ? null : ut(e) ? !1 : st(e) && e.readable && !Tn(e);
}
function $n(e) {
  return e && e[Vt] != null ? e[Vt] : typeof (e == null ? void 0 : e.writable) != "boolean" ? null : ut(e) ? !1 : ft(e) && e.writable && !vn(e);
}
function No(e, t) {
  return de(e) ? ut(e) ? !0 : !((t == null ? void 0 : t.readable) !== !1 && In(e) || (t == null ? void 0 : t.writable) !== !1 && $n(e)) : null;
}
function Do(e) {
  var t, r;
...
function ko(e) {
  ...
  return typeof (t == null ? void 0 : t.closed) == "boolean" || typeof (r == null ? void 0 : r.closed) == "boolean" ? (t == null ? void 0 : t.closed) || (r == null ? void 0 : r.closed) : typeof e._closed == "boolean" && Nn(e) ? e._closed : null;
}
function Nn(e) {
...
function Dn(e) {
  return typeof e._sent100 == "boolean" && Nn(e);
}
function Po(e) {
  var t;
...
function Lo(e) {
  if (!de(e))
    return null;
  const t = e._writableState, r = e._readableState, i = t || r;
  return !i && Dn(e) || !!(i && i.autoDestroy && i.emitClose && i.closed === !1);
}
function Oo(e) {
  var t;
  return !!(e && ((t = e[En]) !== null && t !== void 0 ? t : e.readableDidRead || e.readableAborted));
}
function xo(e) {
  var t, r, i, l, s, d, g, R, h, _;
  return !!(e && ((t = (r = (i = (l = (s = (d = e[Sn]) !== null && d !== void 0 ? d : e.readableErrored) !== null && s !== void 0 ? s : e.writableErrored) !== null && l !== void 0 ? l : (g = e._readableState) === null || g === void 0 ? void 0 : g.errorEmitted) !== null && i !== void 0 ? i : (R = e._writableState) === null || R === void 0 ? void 0 : R.errorEmitted) !== null && r !== void 0 ? r : (h = e._readableState) === null || h === void 0 ? void 0 : h.errored) !== null && t !== void 0 ? t : !((_ = e._writableState) === null || _ === void 0) && _.errored));
}
var ye = {
  isDestroyed: ut,
  kIsDestroyed: gn,
  ...
  kIsReadable: Gt,
  kIsClosedPromise: Ro,
  kControllerErrorFunction: Ao,
  kIsWritable: Vt,
  isClosed: ko,
  isDuplexNodeStream: mo,
  isFinished: No,
  isIterable: To,
  isReadableNodeStream: st,
  isReadableStream: Rn,
  isReadableEnded: $o,
  isReadableFinished: Tn,
  isReadableErrored: Mo,
  isNodeStream: de,
  isWebStream: vo,
  isWritable: $n,
  isWritableNodeStream: ft,
  isWritableStream: An,
  isWritableEnded: vn,
  isWritableFinished: Io,
  isWritableErrored: Do,
  isServerRequest: Po,
  isServerResponse: Dn,
  willEmitClose: Lo,
  isTransformStream: mn
};
const ge = $e, { AbortError: Mn, codes: Wo } = ie, { ERR_INVALID_ARG_TYPE: Co, ERR_STREAM_PREMATURE_CLOSE: Nr } = Wo, { kEmptyObject: Ht, once: qt } = te, { validateAbortSignal: jo, validateFunction: Fo, validateObject: Uo, validateBoolean: Bo } = Ye, { Promise: Go, PromisePrototypeThen: Vo, SymbolDispose: kn } = H, {
  isClosed: Ho,
  isReadable: Dr,
...
function Pn(e, t, r) {
  var i, l;
  if (arguments.length === 2 ? (r = t, t = Ht) : t == null ? t = Ht : Uo(t, "options"), Fo(r, "callback"), jo(t.signal, "options.signal"), r = qt(r), qo(e) || Yo(e))
    return Qo(e, t, r);
  if (!zo(e))
    throw new Co("stream", ["ReadableStream", "WritableStream", "Stream"], e);
  const s = (i = t.readable) !== null && i !== void 0 ? i : Tt(e), d = (l = t.writable) !== null && l !== void 0 ? l : Lr(e), g = e._writableState, R = e._readableState, h = () => {
    e.writable || c();
  };
  let _ = Ko(e) && Tt(e) === s && Lr(e) === d, v = Or(e, !1);
  const c = () => {
...
function Qo(e, t, r) {
  ...
  return Vo(e[Xo].promise, s, s), Yt;
}
function Zo(e, t) {
  var r;
  let i = !1;
  return t === null && (t = Ht), (r = t) !== null && r !== void 0 && r.cleanup && (Bo(t.cleanup, "cleanup"), i = t.cleanup), new Go((l, s) => {
    const d = Pn(e, t, (g) => {
      i && d(), g ? s(g) : l();
    });
  });
...
ir.exports = Pn;
ir.exports.finished = Zo;
var Se = ir.exports;
const fe = $e, {
  aggregateTwoErrors: el,
  codes: { ERR_MULTIPLE_CALLBACK: tl },
  AbortError: rl
} = ie, { Symbol: Ln } = H, { kIsDestroyed: nl, isDestroyed: il, isFinished: ol, isServerRequest: ll } = ye, On = Ln("kDestroy"), zt = Ln("kConstruct");
function xn(e, t, r) {
  e && (e.stack, t && !t.errored && (t.errored = e), r && !r.errored && (r.errored = e));
}
function al(e, t) {
  const r = this._readableState, i = this._writableState, l = i || r;
  return i != null && i.destroyed || r != null && r.destroyed ? (typeof t == "function" && t(), this) : (xn(e, i, r), i && (i.destroyed = !0), r && (r.destroyed = !0), l.constructed ? Wr(this, e, t) : this.once(On, function(s) {
    Wr(this, el(s, e), t);
  }), this);
}
function Wr(e, t, r) {
  ...
  function l(s) {
    ...
    xn(s, g, d), g && (g.closed = !0), d && (d.closed = !0), typeof r == "function" && r(s), s ? fe.nextTick(sl, e, s) : fe.nextTick(Wn, e);
  }
  try {
    e._destroy(t || null, l);
  } catch (s) {
...
function Xt(e, t, r) {
  ...
  if (l != null && l.destroyed || i != null && i.destroyed)
    return this;
  i != null && i.autoDestroy || l != null && l.autoDestroy ? e.destroy(t) : t && (t.stack, l && !l.errored && (l.errored = t), i && !i.errored && (i.errored = t), r ? fe.nextTick(Kt, e, t) : Kt(e, t));
}
function ul(e, t) {
  if (typeof e._construct != "function")
    return;
  const r = e._readableState, i = e._writableState;
  r && (r.constructed = !1), i && (i.constructed = !1), e.once(zt, t), !(e.listenerCount(zt) > 1) && fe.nextTick(dl, e);
}
function dl(e) {
  let t = !1;
  function r(i) {
    ...
    l && (l.constructed = !0), s && (s.constructed = !0), d.destroyed ? e.emit(On, i) : i ? Xt(e, i, !0) : fe.nextTick(cl, e);
  }
  try {
    e._construct((i) => {
      fe.nextTick(r, i);
...
function hl(e, t) {
  e.emit("error", t), fe.nextTick(Cn, e);
}
function bl(e, t) {
  !e || il(e) || (!t && !ol(e) && (t = new rl()), ll(e) ? (e.socket = null, e.destroy(t)) : Cr(e) ? e.abort() : Cr(e.req) ? e.req.abort() : typeof e.destroy == "function" ? e.destroy(t) : typeof e.close == "function" ? e.close() : t ? fe.nextTick(hl, e, t) : fe.nextTick(Cn, e), e.destroyed || (e[nl] = !0));
}
var Fe = {
  construct: ul,
  destroyer: bl,
...
const { ArrayIsArray: pl, ObjectSetPrototypeOf: jn } = H, { EventEmitter: dt } = ot;
function ct(e) {
  dt.call(this, e);
}
jn(ct.prototype, dt.prototype);
jn(ct, dt);
ct.prototype.pipe = function(e, t) {
  ...
  function R(_) {
    h(), dt.listenerCount(this, "error") === 0 && this.emit("error", _);
  }
  Jt(r, "error", R), Jt(e, "error", R);
  function h() {
...
function Jt(e, t, r) {
  ...
  !e._events || !e._events[t] ? e.on(t, r) : pl(e._events[t]) ? e._events[t].unshift(r) : e._events[t] = [r, e._events[t]];
}
var or = {
  Stream: ct,
  prependListener: Jt
...
var ht = Fn.exports;
const { StringPrototypeSlice: jr, SymbolIterator: _l, TypedArrayPrototypeSet: Je, Uint8Array: yl } = H, { Buffer: It } = Ie, { inspect: wl } = te;
var gl = class {
  constructor() {
  ...
  concat(t) {
    if (this.length === 0)
      return It.alloc(0);
    const r = It.allocUnsafe(t >>> 0);
    let i = this.head, l = 0;
    for (; i; )
      Je(r, i.data, l), l += i.data.length, i = i.next;
    return r;
  }
  ...
  *[_l]() {
  ...
  _getString(t) {
    ...
    do {
      ...
      if (t > s.length)
        ...
        t === s.length ? (r += s, ++l, i.next ? this.head = i.next : this.head = this.tail = null) : (r += jr(s, 0, t), this.head = i, i.data = jr(s, t));
        break;
      }
      ++l;
    } while ((i = i.next) !== null);
  ...
  _getBuffer(t) {
    const r = It.allocUnsafe(t), i = t;
    let l = this.head, s = 0;
    do {
      const d = l.data;
      if (t > d.length)
        Je(r, d, i - t), t -= d.length;
      else {
        t === d.length ? (Je(r, d, i - t), ++s, l.next ? this.head = l.next : this.head = this.tail = null) : (Je(r, new yl(d.buffer, d.byteOffset, t), i - t), this.head = l, l.data = d.slice(t));
        break;
      }
      ++s;
    } while ((l = l.next) !== null);
...
const { MathFloor: Sl, NumberIsInteger: El } = H, { validateInteger: Rl } = Ye, { ERR_INVALID_ARG_VALUE: Al } = ie.codes;
let Un = 16 * 1024, Bn = 16;
function ml(e, t, r) {
...
function Tl(e, t, r, i) {
  ...
  return Gn(e.objectMode);
}
var bt = {
  getHighWaterMark: Tl,
  getDefaultHighWaterMark: Gn,
  setDefaultHighWaterMark: vl
};
const Fr = $e, { PromisePrototypeThen: Il, SymbolAsyncIterator: Ur, SymbolIterator: Br } = H, { Buffer: $l } = Ie, { ERR_INVALID_ARG_TYPE: Nl, ERR_STREAM_NULL_VALUES: Dl } = ie.codes;
function Ml(e, t, r) {
  let i;
  ...
  if (t && t[Ur])
    ...
    throw new Nl("iterable", ["Iterable"], t);
  const s = new e({
    objectMode: !0,
    highWaterMark: 1,
...
function pt() {
  ...
  $t = D, D.ReadableState = he;
  const { EventEmitter: u } = ot, { Stream: m, prependListener: b } = or, { Buffer: A } = Ie, { addAbortSignal: k } = ht, M = Se;
  let y = te.debuglog("stream", (n) => {
    y = n;
  });
  const F = gl, P = Fe, { getHighWaterMark: X, getDefaultHighWaterMark: oe } = bt, {
    ...
    AbortError: W
  } = ie, { validateObject: L } = Ye, O = c("kPaused"), { StringDecoder: Y } = bi(), z = Vn;
  g(D.prototype, m.prototype), g(D, m);
  const V = () => {
  }, { errorOrDestroy: K } = P, C = 1, ce = 2, N = 4, J = 8, se = 16, ke = 32, Pe = 64, Le = 128, Ue = 256, yt = 512, Be = 1024, Oe = 2048, a = 4096, f = 8192, p = 16384, I = 32768, $ = 65536, U = 1 << 17, G = 1 << 18;
  function j(n) {
    return {
      enumerable: !1,
      get() {
  ...
  s(he.prototype, {
    ...
    needReadable: j(Pe),
    emittedReadable: j(Le),
    readableListening: j(Ue),
    resumeScheduled: j(yt),
  ...
  function he(n, o, S) {
    typeof S != "boolean" && (S = o instanceof pe()), this.state = Oe | a | se | ke, n && n.objectMode && (this.state |= C), S && n && n.readableObjectMode && (this.state |= C), this.highWaterMark = n ? X(this, n, "readableHighWaterMark", S) : oe(!1), this.buffer = new F(), this.length = 0, this.pipes = [], this.flowing = null, this[O] = null, n && n.emitClose === !1 && (this.state &= ~Oe), n && n.autoDestroy === !1 && (this.state &= ~a), this.errored = null, this.defaultEncoding = n && n.defaultEncoding || "utf8", this.awaitDrainWriters = null, this.decoder = null, this.encoding = null, n && n.encoding && (this.decoder = new Y(n.encoding), this.encoding = n.encoding);
  }
  function D(n) {
  ...
  function we(n, o, S, E) {
    ...
    if (T.state & C || (typeof o == "string" ? (S = S || T.defaultEncoding, T.encoding !== S && (E && T.encoding ? o = A.from(o, S).toString(T.encoding) : (o = A.from(o, S), S = ""))) : o instanceof A ? S = "" : m._isUint8Array(o) ? (o = m._uint8ArrayToBuffer(o), S = "") : o != null && (Z = new q("chunk", ["string", "Buffer", "Uint8Array"], o))), Z)
      ...
      if (E)
        ...
        if (T.destroyed || T.errored)
          return !1;
        T.state &= ~J, T.decoder && !S ? (o = T.decoder.write(o), T.objectMode || o.length !== 0 ? wt(n, T, o, !1) : Xe(n, T)) : wt(n, T, o, !1);
      }
    else
      E || (T.state &= ~J, Xe(n, T));
  ...
  function wt(n, o, S, E) {
    o.flowing && o.length === 0 && !o.sync && n.listenerCount("data") > 0 ? (o.state & $ ? o.awaitDrainWriters.clear() : o.awaitDrainWriters = null, o.dataEmitted = !0, n.emit("data", S)) : (o.length += o.objectMode ? 1 : S.length, E ? o.buffer.unshift(S) : o.buffer.push(S), o.state & Pe && Ke(n)), Xe(n, o);
  }
  ...
  D.prototype.read = function(n) {
    ...
    if (n > o.highWaterMark && (o.highWaterMark = ni(n)), n !== 0 && (o.state &= ~Le), n === 0 && o.needReadable && ((o.highWaterMark !== 0 ? o.length >= o.highWaterMark : o.length > 0) || o.ended))
      return y("read: emitReadable", o.length, o.ended), o.length === 0 && o.ended ? gt(this) : Ke(this), null;
    if (n = dr(n, o), n === 0 && o.ended)
      return o.length === 0 && gt(this), null;
    let E = (o.state & Pe) !== 0;
    if (y("need readable", E), (o.length === 0 || o.length - n < o.highWaterMark) && (E = !0, y("length less than watermark", E)), o.ended || o.reading || o.destroyed || o.errored || !o.constructed)
      ...
      y("do read"), o.state |= J | ke, o.length === 0 && (o.state |= Pe);
      try {
    ...
    let T;
    return n > 0 ? T = _r(n, o) : T = null, T === null ? (o.needReadable = o.length <= o.highWaterMark, n = 0) : (o.length -= n, o.multiAwaitDrain ? o.awaitDrainWriters.clear() : o.awaitDrainWriters = null), o.length === 0 && (o.ended || (o.needReadable = !0), S !== n && o.ended && gt(this)), T !== null && !o.errorEmitted && !o.closeEmitted && (o.dataEmitted = !0, this.emit("data", T)), T;
  };
  function ii(n, o) {
    if (y("onEofChunk"), !o.ended) {
      ...
      o.ended = !0, o.sync ? Ke(n) : (o.needReadable = !1, o.emittedReadable = !0, cr(n));
    }
  }
  function Ke(n) {
  ...
  function Xe(n, o) {
    !o.readingMore && o.constructed && (o.readingMore = !0, e.nextTick(oi, n, o));
  }
  function oi(n, o) {
  ...
  D.prototype._read = function(n) {
    ...
    function le(Re, be) {
      y("onunpipe"), Re === S && be && be.hasUnpiped === !1 && (be.hasUnpiped = !0, hi());
    }
    function wr() {
      y("onend"), n.end();
    }
    let Ee, gr = !1;
    function hi() {
      y("cleanup"), n.removeListener("close", Rt), n.removeListener("finish", At), Ee && n.removeListener("drain", Ee), n.removeListener("error", Et), n.removeListener("unpipe", le), S.removeListener("end", wr), S.removeListener("end", Ge), S.removeListener("data", Er), gr = !0, Ee && E.awaitDrainWriters && (!n._writableState || n._writableState.needDrain) && Ee();
    }
    function Sr() {
      gr || (E.pipes.length === 1 && E.pipes[0] === n ? (y("false write response, pause", 0), E.awaitDrainWriters = n, E.multiAwaitDrain = !1) : E.pipes.length > 1 && E.pipes.includes(n) && (y("false write response, pause", E.awaitDrainWriters.size), E.awaitDrainWriters.add(n)), S.pause()), Ee || (Ee = li(S, n), n.on("drain", Ee));
    }
    S.on("data", Er);
    function Er(Re) {
      y("ondata");
    ...
    function Et(Re) {
      if (y("onerror", Re), Ge(), n.removeListener("error", Et), n.listenerCount("error") === 0) {
        const be = n._writableState || n._readableState;
        be && !be.errorEmitted ? K(n, Re) : n.emit("error", Re);
      }
    }
    b(n, "error", Et);
    function Rt() {
      n.removeListener("finish", At), Ge();
    }
    n.once("close", Rt);
    function At() {
      y("onfinish"), n.removeListener("close", Rt), Ge();
    }
    n.once("finish", At);
    function Ge() {
      y("unpipe"), S.unpipe(n);
  ...
  D.prototype.unpipe = function(n) {
    ...
    return n === "data" ? (E.readableListening = this.listenerCount("readable") > 0, E.flowing !== !1 && this.resume()) : n === "readable" && !E.endEmitted && !E.readableListening && (E.readableListening = E.needReadable = !0, E.flowing = !1, E.emittedReadable = !1, y("on readable", E.length, E.reading), E.length ? Ke(this) : E.reading || e.nextTick(ai, this)), S;
  ...
  D.prototype.resume = function() {
    const n = this._readableState;
    return n.flowing || (y("resume"), n.flowing = !n.readableListening, si(this, n)), n[O] = !1, this;
  };
  function si(n, o) {
    o.resumeScheduled || (o.resumeScheduled = !0, e.nextTick(fi, n, o));
  }
  function fi(n, o) {
  ...
  function gt(n) {
    const o = n._readableState;
    y("endReadable", o.endEmitted), o.endEmitted || (o.ended = !0, e.nextTick(di, o, n));
  }
  function di(n, o) {
...
function lr() {
  ...
  Nt = L, L.WritableState = w;
  const { EventEmitter: _ } = ot, v = or.Stream, { Buffer: c } = Ie, u = Fe, { addAbortSignal: m } = ht, { getHighWaterMark: b, getDefaultHighWaterMark: A } = bt, {
  ...
  function w(a, f, p) {
    ...
    this.decodeStrings = !I, this.defaultEncoding = a && a.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = K.bind(void 0, f), this.writecb = null, this.writelen = 0, this.afterWriteTickInfo = null, W(this), this.pendingcb = 0, this.constructed = !0, this.prefinished = !1, this.errorEmitted = !1, this.emitClose = !a || a.emitClose !== !1, this.autoDestroy = !a || a.autoDestroy !== !1, this.errored = null, this.closed = !1, this.closeEmitted = !1, this[x] = [];
  }
  function W(a) {
  ...
  L.prototype.write = function(a, f, p) {
    ...
    a.corked && (a.corked--, a.writing || J(this, a));
  ...
  function K(a, f) {
    ...
    p.writing = !1, p.writecb = null, p.length -= p.writelen, p.writelen = 0, f ? (f.stack, p.errored || (p.errored = f), a._readableState && !a._readableState.errored && (a._readableState.errored = f), I ? e.nextTick(V, a, p, f, $) : V(a, p, f, $)) : (p.buffered.length > p.bufferedIndex && J(a, p), I ? p.afterWriteTickInfo !== null && p.afterWriteTickInfo.cb === $ ? p.afterWriteTickInfo.count++ : (p.afterWriteTickInfo = {
      count: 1,
      cb: $,
      stream: a,
      state: p
  ...
  function N(a) {
    ...
    for (let $ = a.bufferedIndex; $ < a.buffered.length; ++$) {
      var f;
      const { chunk: U, callback: G } = a.buffered[$], j = a.objectMode ? 1 : U.length;
      a.length -= j, G(
  ...
  function J(a, f) {
    ...
    if (f.bufferProcessing = !0, U > 1 && a._writev) {
      f.pendingcb -= U - 1;
      const j = f.allNoop ? ne : (D) => {
        for (let we = G; we < p.length; ++we)
          p[we].callback(D);
      }, he = f.allNoop && G === 0 ? p : t(p, G);
      he.allBuffers = f.allBuffers, z(a, f, !0, f.length, he, "", j), W(f);
    } else {
      do {
        const { chunk: j, encoding: he, callback: D } = p[G];
        p[G++] = null;
        const we = $ ? 1 : j.length;
        z(a, f, !1, we, j, he, D);
  ...
  L.prototype._write = function(a, f, p) {
    ...
    return I.corked && (I.corked = 1, this.uncork()), $ || (!I.errored && !I.ending ? (I.ending = !0, Le(this, I, !0), I.ended = !0) : I.finished ? $ = new X("end") : I.destroyed && ($ = new P("end"))), typeof p == "function" && ($ || I.finished ? e.nextTick(p, $) : I[x].push(p)), this;
  };
  function se(a) {
  ...
  L.prototype.destroy = function(a, f) {
    const p = this._writableState;
    return !p.destroyed && (p.bufferedIndex < p.buffered.length || p[x].length) && e.nextTick(N, p), yt.call(this, a, f), this;
...
function kl() {
  ...
  } = ie, { destroyer: b } = Fe, A = pe(), k = pt(), M = lr(), { createDeferredPromise: y } = te, F = Vn, P = globalThis.Blob || t.Blob, X = typeof P < "u" ? function(w) {
    return w instanceof P;
  } : function(w) {
    return !1;
  }, oe = globalThis.AbortController || qe().AbortController, { FunctionPrototypeCall: B } = H;
  class q extends A {
    constructor(w) {
  ...
  Dt = function x(w, W) {
    ...
    if (typeof w == "function") {
      const { value: O, write: Y, final: z, destroy: V } = re(w);
      if (l(O))
        return F(q, O, {
      ...
      value: x(
        async function* () {
          for (; ; ) {
            const z = w;
            w = null;
            const { chunk: V, done: K, cb: C } = await z;
            if (e.nextTick(C), K)
              return;
            if (O.aborted)
              throw new c(void 0, {
  ...
  function ne(x) {
    ...
    let L = !!r(w), O = !!i(W), Y, z, V, K, C;
    function ce(N) {
      const J = K;
      K = null, J ? J(N) : N && C.destroy(N);
    }
    return C = new q({
      // TODO (ronag): highWaterMark?
    ...
    }), C._destroy = function(N, J) {
      !N && K !== null && (N = new c()), V = null, Y = null, z = null, K === null ? J(N) : (K = J, b(W, N), b(w, N));
    }, C;
  }
  return Dt;
}
...
function pe() {
  ...
  return d.from = function(_) {
    return h || (h = kl()), h(_, "body");
  }, Mt;
}
const { ObjectSetPrototypeOf: Hn, Symbol: Pl } = H;
var qn = _e;
const { ERR_METHOD_NOT_IMPLEMENTED: Ll } = ie.codes, ar = pe(), { getHighWaterMark: Ol } = bt;
Hn(_e.prototype, ar.prototype);
Hn(_e, ar);
const He = Pl("kCallback");
function _e(e) {
  if (!(this instanceof _e))
    return new _e(e);
  const t = e ? Ol(this, e, "readableHighWaterMark", !0) : null;
  t === 0 && (e = {
    ...e,
    highWaterMark: null,
  ...
  }), ar.call(this, e), this._readableState.sync = !1, this[He] = null, e && (typeof e.transform == "function" && (this._transform = e.transform), typeof e.flush == "function" && (this._flush = e.flush)), this.on("prefinish", xl);
}
function Qt(e) {
...
const { ObjectSetPrototypeOf: Yn } = H;
var zn = Ce;
const sr = qn;
Yn(Ce.prototype, sr.prototype);
Yn(Ce, sr);
function Ce(e) {
...
const Ve = $e, { ArrayIsArray: Wl, Promise: Cl, SymbolAsyncIterator: jl, SymbolDispose: Fl } = H, nt = Se, { once: Ul } = te, Bl = Fe, Yr = pe(), {
  aggregateTwoErrors: Gl,
  codes: {
    ERR_INVALID_ARG_TYPE: Zt,
    ERR_INVALID_RETURN_VALUE: kt,
    ERR_MISSING_ARGS: Vl,
    ERR_STREAM_DESTROYED: Hl,
    ERR_STREAM_PREMATURE_CLOSE: ql
  },
  AbortError: Yl
} = ie, { validateFunction: zl, validateAbortSignal: Kl } = Ye, {
  isIterable: me,
  isReadable: Pt,
  isReadableNodeStream: tt,
  isNodeStream: zr,
  ...
  isWebStream: Xl,
  isReadableStream: Lt,
  isReadableFinished: Jl
} = ye, Ql = globalThis.AbortController || qe().AbortController;
let Ot, xt, Wt;
function Kr(e, t, r) {
  let i = !1;
  e.on("close", () => {
  ...
  return {
    destroy: (s) => {
      i || (i = !0, Bl.destroyer(e, s || new Hl("pipe")));
    },
    cleanup: l
  };
}
function Zl(e) {
  return zl(e[e.length - 1], "streams[stream.length - 1]"), e.pop();
}
function Ct(e) {
  if (me(e))
    return e;
...
async function* ea(e) {
  xt || (xt = pt()), yield* xt.prototype[jl].call(e);
}
async function Qe(e, t, r, { end: i }) {
  let l, s = null;
  const d = (h) => {
    if (h && (l = h), s) {
      const _ = s;
...
function Kn(e, t, r) {
  if (e.length === 1 && Wl(e[0]) && (e = e[0]), e.length < 2)
    throw new Vl("streams");
  const i = new Ql(), l = i.signal, s = r == null ? void 0 : r.signal, d = [];
  Kl(s, "options.signal");
  function g() {
    m(new Yl());
  }
  Wt = Wt || te.addAbortListener;
  let R;
  s && (R = Wt(s, g));
  let h, _;
  const v = [];
  ...
  function m(M, y) {
    ...
    if (M && (!h || h.code === "ERR_STREAM_PREMATURE_CLOSE") && (h = M), !(!h && !y)) {
      for (; v.length; )
        v.shift()(h);
      (F = R) === null || F === void 0 || F[Fl](), i.abort(), y && (h || d.forEach((P) => P()), Ve.nextTick(t, h, _));
    }
  }
  let b;
  for (let M = 0; M < e.length; M++) {
    const y = e[M], F = M < e.length - 1, P = M > 0, X = F || (r == null ? void 0 : r.end) !== !1, oe = M === e.length - 1;
    if (zr(y)) {
      let B = function(q) {
        q && q.name !== "AbortError" && q.code !== "ERR_STREAM_PREMATURE_CLOSE" && u(q);
      };
      if (X) {
        const { destroy: q, cleanup: re } = Kr(y, F, P);
        v.push(q), Pt(y) && oe && d.push(re);
      }
      y.on("error", B), Pt(y) && oe && d.push(() => {
    ...
    if (M === 0)
      if (typeof y == "function") {
        if (b = y({
          ...
          throw new kt("Iterable, AsyncIterable or Stream", "source", b);
      } else
        me(y) || tt(y) || xe(y) ? b = y : b = Yr.from(y);
    else if (typeof y == "function") {
      if (xe(b)) {
        var A;
        b = Ct((A = b) === null || A === void 0 ? void 0 : A.readable);
      } else
        b = Ct(b);
      if (b = y(b, {
        signal: l
        ...
        if (!me(b, !0))
          throw new kt("AsyncIterable", `transform[${M - 1}]`, b);
      } else {
        var k;
        Ot || (Ot = zn);
        const B = new Ot({
        ...
        if (typeof q == "function")
          c++, q.call(
            b,
            (x) => {
              _ = x, x != null && B.write(x), X && B.end(), Ve.nextTick(u);
            },
            (x) => {
          ...
          throw new kt("AsyncIterable or Promise", "destination", b);
        b = B;
        const { destroy: re, cleanup: ne } = Kr(b, !1, !0);
...
function ra(e, t, r, { end: i }) {
  ...
  if (t.on("close", () => {
    ...
    Jl(e) ? Ve.nextTick(s) : e.once("end", s);
  } else
    r();
  return nt(
    e,
...
const { pipeline: na } = fr, Ze = pe(), { destroyer: ia } = Fe, {
  isNodeStream: et,
  isReadable: Xr,
  isWritable: Jr,
  isWebStream: Ft,
  ...
  AbortError: oa,
  codes: { ERR_INVALID_ARG_VALUE: en, ERR_MISSING_ARGS: la }
} = ie, aa = Se;
var Xn = function(...t) {
  if (t.length === 0)
  ...
  if (t.length === 1)
    return Ze.from(t[0]);
  const r = [...t];
  if (typeof t[0] == "function" && (t[0] = Ze.from(t[0])), typeof t[t.length - 1] == "function") {
    const u = t.length - 1;
    t[u] = Ze.from(t[u]);
  }
  for (let u = 0; u < t.length; ++u)
    if (!(!et(t[u]) && !Ft(t[u]))) {
      if (u < t.length - 1 && !(Xr(t[u]) || Zr(t[u]) || Ae(t[u])))
        throw new en(`streams[${u}]`, r[u], "must be readable");
      if (u > 0 && !(Jr(t[u]) || Qr(t[u]) || Ae(t[u])))
  ...
  const h = t[0], _ = na(t, R), v = !!(Jr(h) || Qr(h) || Ae(h)), c = !!(Xr(_) || Zr(_) || Ae(_));
  if (g = new Ze({
    // TODO (ronag): highWaterMark?
  ...
  return g._destroy = function(u, m) {
    !u && d !== null && (u = new oa()), s = null, i = null, l = null, d === null ? m(u) : (d = m, et(_) && ia(_, u));
  }, g;
};
const sa = globalThis.AbortController || qe().AbortController, {
  codes: { ERR_INVALID_ARG_VALUE: fa, ERR_INVALID_ARG_TYPE: ze, ERR_MISSING_ARGS: ua, ERR_OUT_OF_RANGE: da },
  AbortError: ue
} = ie, { validateAbortSignal: De, validateInteger: tn, validateObject: Me } = Ye, ca = H.Symbol("kWeak"), ha = H.Symbol("kResistStopPropagation"), { finished: ba } = Se, pa = Xn, { addAbortSignalNoValidate: _a } = ht, { isWritable: ya, isNodeStream: wa } = ye, { deprecate: ga } = te, {
  ArrayPrototypePush: Sa,
  Boolean: Ea,
  MathFloor: rn,
  Number: Ra,
  NumberIsNaN: Aa,
  ...
  Symbol: Jn
} = H, it = Jn("kEmpty"), an = Jn("kEof");
function va(e, t) {
  if (t != null && Me(t, "options"), (t == null ? void 0 : t.signal) != null && De(t.signal, "options.signal"), wa(e) && !ya(e))
    throw new fa("stream", e, "must be writable");
  const r = pa(this, e);
  return t != null && t.signal && _a(t.signal, r), r;
}
function _t(e, t) {
  if (typeof e != "function")
  ...
  return (t == null ? void 0 : t.highWaterMark) != null && (i = rn(t.highWaterMark)), tn(r, "options.concurrency", 1), tn(i, "options.highWaterMark", 0), i += r, (async function* () {
    const s = te.AbortSignalAny(
      [t == null ? void 0 : t.signal].filter(Ea)
    ), d = this, g = [], R = {
      signal: s
    };
    let h, _, v = !1, c = 0;
...
async function Na(e, t) {
  ...
  async function r(i, l) {
    return await e(i, l), it;
  }
  for await (const i of _t.call(this, r, t))
    ;
}
function ur(e, t) {
  if (typeof e != "function")
    throw new ze("fn", ["Function", "AsyncFunction"], e);
  async function r(i, l) {
    return await e(i, l) ? i : it;
  }
  return _t.call(this, r, t);
}
class Da extends ua {
  constructor() {
...
async function Ma(e, t, r) {
  ...
  if (r != null && (i = r.signal) !== null && i !== void 0 && i.aborted) {
    ...
    }), await ba(this.destroy(h)), h;
  }
  const s = new sa(), d = s.signal;
  if (r != null && r.signal) {
    const h = {
      once: !0,
      [ca]: this,
...
function Zn(e) {
  if (e = Ra(e), Aa(e))
    return 0;
  if (e < 0)
    throw new da("number", ">= 0", e);
  return e;
}
function La(e, t = void 0) {
  return t != null && Me(t, "options"), (t == null ? void 0 : t.signal) != null && De(t.signal, "options.signal"), e = Zn(e), (async function* () {
    var i;
...
er.streamReturningOperators = {
  asIndexedPairs: ga(Ta, "readable.asIndexedPairs will be removed in a future version."),
  drop: La,
  filter: ur,
  flatMap: Pa,
  map: _t,
...
function ti() {
  ...
  } = ie, R = Xn, { setDefaultHighWaterMark: h, getDefaultHighWaterMark: _ } = bt, { pipeline: v } = fr, { destroyer: c } = Fe, u = Se, m = ei(), b = ye, A = mt.exports = or.Stream;
  A.isDestroyed = b.isDestroyed, A.isDisturbed = b.isDisturbed, A.isErrored = b.isErrored, A.isReadable = b.isReadable, A.isWritable = b.isWritable, A.Readable = pt();
  for (const M of r(s)) {
    let F = function(...P) {
      if (new.target)
        throw g();
  ...
  A.Writable = lr(), A.Duplex = pe(), A.Transform = qn, A.PassThrough = zn, A.pipeline = v;
  const { addAbortSignal: k } = ht;
...
(function(e) {
  const t = ti(), r = ei(), i = t.Readable.destroy;
...
//# sourceMappingURL=index-DIo3jSo7.js.map

                ...
                <template v-slot:default>
                  <p v-show="!(tableExplorerShown || resourcesExplorerShown)"
                    ...
                    <a href="https://zazuko.com" target="_blank" rel="noopener">
                      <svg class="h-8" clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round"
                        stroke-miterlimit="1.41421" viewBox="0 0 768 260" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <span>/</span>
                    <a href="https://github.com/zazuko/SPEX" target="_blank" rel="noopener noreferer"
                      title="Github repository">
                      <svg class="w-5 h-5 opacity-70 hover:opacity-100" aria-hidden="true" viewBox="0 0 16 16"
